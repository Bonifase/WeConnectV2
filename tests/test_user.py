...
class TestUserCase(BaseTestSetUp):
    ...
    def test_missing_username_key_registration_fails(self):
        ...
        self.assertEqual(result["message"], "username key is missing")
    ...
    def test_non_string_password_registrartion_fails(self):
        ...
        result = json.loads(response.data.decode())
        self.assertEqual(
            result["message"], "Password should contain numbers and characters")
        self.assertEqual(response.status_code, 409)
    ...
    def test_missing_email_key_login_fails(self):
        ...
        result = json.loads(response.data.decode())
        self.assertEqual(result["message"], "email key is missing")
    ...
    def test_missing_password_key_login_fails(self):
        ...
        result = json.loads(response.data.decode())
        self.assertEqual(result["message"], "password key is missing")
