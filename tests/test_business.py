...
class TestBusinessCase(BaseTestSetUp): 
    ...
    def test_short_business_name_does_not_work(self):
        ...
        self.result = self.testHelper.login_user(user_data)
        self.token = json.loads(self.result.data.decode())['access_token']
        response = self.testHelper.create_business(business_data=short_business_name,token=self.token)
        result = json.loads(response.data.decode())
    ...
    def test_integer_business_name_does_not_work(self):
        ...
        self.result = self.testHelper.login_user(user_data)
        self.token = json.loads(self.result.data.decode())['access_token']
        response = self.testHelper.create_business(business_data=integer_business_name,token=self.token)
        result = json.loads(response.data.decode())
        self.assertEqual(result["error"], "Invalid name")
        self.assertEqual(response.status_code, 409)
    ...
    def test_empty_business_name_fails(self):
        ...
        self.result = self.testHelper.login_user(user_data)
        self.token = json.loads(self.result.data.decode())['access_token']
        response = self.testHelper.create_business(business_data=empty_business_name,token=self.token)
        result = json.loads(response.data.decode())
        self.assertEqual(result["error"], "Invalid name")
        self.assertEqual(response.status_code, 409)
    ...
    def test_missing_business_key_name_doesnt_work(self):
        ...
        self.result = self.testHelper.login_user(user_data)
        self.token = json.loads(self.result.data.decode())['access_token']
        response = self.testHelper.create_business(business_data=missing_business_key_name,token=self.token)
        result = json.loads(response.data.decode())
    ...
    def test_update_unavailable_business(self):
        ...
        self.result = self.testHelper.login_user(user_data)
        self.token = json.loads(self.result.data.decode())['access_token']
        response = self.testHelper.update_business(update_data=new_business, token=self.token, businessid=100)
        result = json.loads(response.data.decode())
    ...
    def test_update_with_available_name_fails(self):
        ...
        self.token = json.loads(self.result.data.decode())['access_token']
        self.testHelper.create_business(business_data=business_data, token=self.token)
        response = self.testHelper.update_business(update_data=business_data,token=self.token, businessid=1)
        result = json.loads(response.data.decode())
    ...
    def test_update_with_invalid_location_fails(self):
        ...
        self.token = json.loads(self.result.data.decode())['access_token']
        self.testHelper.create_business(business_data=business_data, token=self.token)
        response = self.testHelper.update_business(update_data=invalid_business_location, token=self.token, businessid=1)
        result = json.loads(response.data.decode())
    ...
    def test_delete_business_works(self):
        ...
        self.token = json.loads(self.result.data.decode())['access_token']
        self.testHelper.create_business(business_data=business_data, token=self.token)
        response = self.testHelper.delete_business(businessid=1, token=self.token)
        result = json.loads(response.data.decode())
