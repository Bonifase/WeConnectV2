...
non_string_password = dict(username = "username", email = "username@gmail.com", password = 1)
invalid_password = dict(username="user123", password=".", email="user123@gmail.com")
new_user = dict(username="Bill", email="bill@gmail.com",password="123456")
duplicate_user = dict(username="username", email="user@gmail.com",password="user123")
wrong_email = dict(email="user3@gmail.com",password="user123")
empty_login = dict(email = "", password = "")
unregistered_user = dict(email="notregistered@email.com", username="someuser",
