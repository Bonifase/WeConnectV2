...
class AppTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.data = {"reviewbody":"This is my first best review"}
        self.data2 = {"reviewbody":"This is my second review"}
    ...
    #     response = self.app.post('/api/v2/auth/register', data = json.dumps(self.data3) , content_type = 'application/json')
